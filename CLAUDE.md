...
- CSS entry/customization: `themes/butterfly/source/css/index.styl`, `var.styl`, and `themes/butterfly/source/css/claude-theme-lite.css`
...
There is currently no root `README.md`, prior root `CLAUDE.md`, `.cursorrules`, `.cursor/rules`, or `.github/copilot-instructions.md`. The README under `themes/butterfly/` is upstream Butterfly theme documentation, not repository-level workflow guidance.
